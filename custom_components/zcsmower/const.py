...
ROBOT_WAKE_UP_INTERVAL_DEFAULT = CONFIGURATION_DEFAULTS.get(CONF_WAKE_UP_INTERVAL_DEFAULT).get("default")
ROBOT_WAKE_UP_INTERVAL_INFINITY = CONFIGURATION_DEFAULTS.get(CONF_WAKE_UP_INTERVAL_INFINITY).get("default")
ROBOT_MODELS = {
    "AM015D": "L15 Deluxe",
