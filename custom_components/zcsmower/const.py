...
UPDATE_INTERVAL_WORKING_DEFAULT = CONFIGURATION_DEFAULTS.get(CONF_UPDATE_INTERVAL_WORKING).get("default")
UPDATE_INTERVAL_STANDBY_DEFAULT = CONFIGURATION_DEFAULTS.get(CONF_UPDATE_INTERVAL_STANDBY).get("default")
UPDATE_INTERVAL_IDLING_DEFAULT = CONFIGURATION_DEFAULTS.get(CONF_UPDATE_INTERVAL_IDLING).get("default")
UPDATE_INTERVAL_HIBERNATION_DEFAULT = CONFIGURATION_DEFAULTS.get(CONF_UPDATE_INTERVAL_HIBERNATION).get("default")
