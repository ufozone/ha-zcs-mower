...
* Get account key and IMEI from lawn mower:
    ...
    * ![Registered "Connect Clients"](https://github.com/ufozone/ha-zcs-mower/blob/main/setup_account1.jpg?raw=true | width=200)
    * You need your account key (italicized string):
    * ![Get account key](https://github.com/ufozone/ha-zcs-mower/blob/main/setup_account2.jpg?raw=true | width=200)
    * Now you need the IMEI of your lawn mower
    * Click on the `More info` tab and scroll to the `Connect Informations` section:
    * ![Get IMEI address](https://github.com/ufozone/ha-zcs-mower/blob/main/setup_imei.jpg?raw=true | width=200)
